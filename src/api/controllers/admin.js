      ...
      if (!errors.isEmpty()) {
        ...
        let from = `TBA tba@outlook.com`,
          ...
          html = `<p>Good Day ${user.companyName}</p> 
                  <p>We wish to announce to you that your account has been approved after the review of your credentials from our end, thank you.</p>`;
...
exports.suspendHost = async (req, res) => {
    ...
    try {
        ...
        res.status(400)
        .json({ error: "Error: Host Suspension Failed, please try again." });
    }
}
